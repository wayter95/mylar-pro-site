  ...
  plans: [
    {
      ...
      price: 197,
      priceAnnual: 167,
      tagline: "Pra começar a organizar sua carteira hoje.",
      idealFor: "Corretor solo nos primeiros 12 meses, com até 50 imóveis.",
      limits: [
        { v: "50", l: "Imóveis" },
        { v: "1", l: "Usuário" },
      ],
      features: [
        ...
        "Inbox unificado para conversas",
    ...
    },
    {
      ...
      price: 297,
      priceAnnual: 252,
      tagline: "Acelere com automações e WhatsApp.",
      idealFor:
        "Corretor consolidado fechando 3-8 negócios/mês, dependente de WhatsApp.",
      featured: true,
      badge: "Mais popular",
      limits: [
        { v: "100", l: "Imóveis" },
      ...
      features: [
        "Tudo do Essencial",
        "Automações no CRM e propostas digitais",
        "WhatsApp + templates de mensagem",
        "Catálogo customizável com sua marca",
        "Contratos com modelos prontos",
        "App do Corretor (mobile)",
      ],
    ...
    },
    {
      ...
      price: 397,
      priceAnnual: 337,
      tagline: "Profissionalize com domínio próprio e assinatura digital.",
      idealFor:
        "Corretor com marca pessoal forte que quer sair de portais e ter site próprio.",
      limits: [
        { v: "200", l: "Imóveis" },
        { v: "1", l: "Usuário" },
      ],
      features: [
        ...
        "Split de comissão entre parceiros",
        "Domínio próprio (seusite.com.br)",
