  ...
  plans: [
    {
      ...
      price: 497,
      priceAnnual: 422,
      tagline: "Portal do cliente, cobrança e reajuste automáticos.",
      idealFor: "Imobiliária com até 300 imóveis e equipe enxuta de 3-5 agentes.",
      limits: [
        { v: "300", l: "Imóveis" },
        { v: "5", l: "Agentes" },
      ],
      features: [
        "Tudo do Corretor Avançado",
        "Portal do Cliente (inquilinos e proprietários)",
        "Cobrança automática (boletos e PIX)",
        "Acordos e parcelamentos de dívida",
        "Reajuste de aluguel (IGP-M, IPCA, INPC)",
    ...
    },
    {
      ...
      price: 697,
      priceAnnual: 592,
      tagline: "Operação completa de gestão predial.",
      idealFor: "Imobiliária com locação ativa, equipe técnica de vistoria e chamados.",
      featured: true,
      badge: "Mais popular",
      limits: [
        { v: "800", l: "Imóveis" },
      ...
      features: [
        ...
        "Chamados e ordens de manutenção",
        "Controle de chaves",
        "Vistorias digitais",
        "Fornecedores cadastrados",
        "Quadros Kanban com automações",
        "Repasses e pagamento de comissões",
      ],
      cta: "Agendar demo",
      contactSales: true,
    },
    {
      ...
      price: 797,
      priceAnnual: 677,
      tagline: "Controle financeiro de nível enterprise.",
      idealFor: "Imobiliária com financeiro estruturado que precisa de DRE, DIMOB e BI.",
      limits: [
        { v: "1.000", l: "Imóveis" },
        { v: "40", l: "Agentes" },
      ],
    ...
    groups: [
      {
        name: "CRM & catálogo",
        rows: [
          ["Tudo de Corretor Avançado", true, true, true],
          ["Domínio próprio", true, true, true],
          ["App do Corretor", true, true, true],
        ],
      },
      {
        name: "Portal & cobrança",
        rows: [
          ["Portal do Cliente", true, true, true],
          ["Boletos e PIX automáticos", true, true, true],
          ["Reajuste IGP-M/IPCA", true, true, true],
          ["Régua de cobrança avançada", false, true, true],
        ],
      },
      {
        name: "Operação predial",
        rows: [
          ["Chamados & manutenção", false, true, true],
          ["Vistorias digitais", false, true, true],
          ["Controle de chaves", false, true, true],
          ["Fornecedores", false, true, true],
          ["Quadros Kanban + automações", false, true, true],
        ],
      },
      {
        name: "Financeiro",
        rows: [
          ["Repasses & comissões", false, true, true],
          ["Conciliação bancária", false, false, true],
          ["DRE gerencial", false, false, true],
          ["DIMOB + Informe", false, false, true],
          ["BI avançado", false, false, true],
        ],
      },
    ],
  },
